    ...
    return (
        ...
        >
            <section className='container mx-auto px-5'>
                ...
                <br />
                <P className="mb-2"> After registering for annotation task, you may continue on to annotate street view images in our website.
                    You are to:  </P>
                ...
                <P className="mb-2"> By participating in our study, you agree to the following: </P>
